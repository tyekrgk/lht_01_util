...
public class NumberTool {
	 ...
	 public static Logger logger = Logger.getLogger(NumberTool.class.getClass());
	...
	public static void main(String[] args){
		//传给网银
		logger.debug(NumberTool.moneyToStr(9000.04f));
		
		//网银传回来的
		logger.debug(NumberTool.strToMoney("9000.04"));
		
		//从数据库取出的
		logger.debug(NumberTool.toMoney(9000.04001f));
