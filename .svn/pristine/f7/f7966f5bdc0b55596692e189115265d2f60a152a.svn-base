...
public enum CardinalityEnum {
     ...
     */
    private CardinalityEnum(String name) {
        this.name = name;
    }
     ...
     */
    public CardinalityEnum reverse() {
     ...
     */
    public static CardinalityEnum parse(String cardinality) {
        if (cardinality == null || "".equals(cardinality)) {
            return null;
        }
        for (CardinalityEnum card: CardinalityEnum.values()) {
